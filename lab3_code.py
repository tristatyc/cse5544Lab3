...
ax1 = sns.heatmap(p1_data.T, linewidth = 0.5, cmap = "hot_r")
...
st.write("This heatmap is clear in delivering information about emission by countries and years to audiences. Since the original data has extreme large and small values, which makes the colormap not so clear in color representation, I have used 'log' to normalize the emission values, and this makes this plot clearer in differentiating colors and  more beautiful. Additionally, the labels of axes and title of the heatmap are all listed, which can help audiences understand the context and information better.")
